  ...
  describe('findOne', () => {
    ...
    describe('positive cases', () => {
      it('returns todo DTO by id', async () => {
        ...
        expect(result).toBeInstanceOf(TodoResponseDto);
        expect(result.id).toBe('todo-1');
        expect(service.findOne).toHaveBeenCalledWith('todo-1', 'user-1');
      });
    });
  });
  ...
  describe('remove', () => {
    ...
    describe('positive cases', () => {
      it('calls service remove and returns void', async () => {
        ...
        expect(service.remove).toHaveBeenCalledWith('todo-1', 'user-1');
      });
    });
  });
  ...
  describe('update', () => {
    ...
    describe('positive cases', () => {
      it('updates and returns todo DTO', async () => {
        ...
        expect(result).toBeInstanceOf(TodoResponseDto);
        expect(service.update).toHaveBeenCalledWith('todo-1', 'user-1', { title: 'Updated' });
      });
    });
  });
});
