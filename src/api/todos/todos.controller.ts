...
export class TodosController {
  ...
  @ApiErrors(DtoValidationError, UserIsNotAuthorizedError, InternalServerError)
  ...
  @ApiErrors(DtoValidationError, TodoNotFoundError, UserIsNotAuthorizedError, InternalServerError)
  @ApiOk(TodoResponseDto, {
    access: true,
